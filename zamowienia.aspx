<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="zamowienia.aspx.cs" Inherits="sklepBHP.order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-placeholder">
            ...
            <asp:SqlDataSource ID="zamowienielistSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:sklepBHPConnectionString %>" SelectCommand="SELECT Imie + ' ' + Nazwisko + ', ' + Numer_telefonu AS Klient, ID_klient FROM Klienci"></asp:SqlDataSource>
            ...
            <asp:GridView ID="zamowieniaGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID_zamowienia" DataSourceID="zamowieniaSqlDataSource">
                <Columns>
                    ...
                    <asp:BoundField DataField="Adres_email" HeaderText="Adres_email" SortExpression="Adres_email" />
                    <asp:CommandField ShowEditButton="True" />
                    <asp:CommandField ShowDeleteButton="True" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="zamowieniaSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:sklepBHPConnectionString %>" 
                ...
                UpdateCommand="UPDATE [Zamowienia] SET [ID_klient] = @ID_klient, [Data_zamowienia] = @Data_zamowienia, [Status_zamowienia] = @Status_zamowienia WHERE [ID_zamowienia] = @ID_zamowienia">
                <DeleteParameters>
