<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="pozycjeZamowienia.aspx.cs" Inherits="sklepBHP.position" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="content-placeholder">
            ...
            <asp:SqlDataSource ID="produktPozycjaSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:sklepBHPConnectionString %>" SelectCommand="SELECT Nazwa + ', ' + CAST(Cena AS NVARCHAR(10)) AS Produkt, ID_produkt FROM Produkty"></asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="zamowieniepozycjaSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:sklepBHPConnectionString %>" SelectCommand="SELECT CONVERT (NVARCHAR(10), Zamowienia.Data_zamowienia, 103) + ' - ' + Klienci.Imie + ' ' + Klienci.Nazwisko + ', ' + Klienci.Numer_telefonu AS Zamowienie, Zamowienia.ID_zamowienia FROM Zamowienia INNER JOIN Klienci ON Zamowienia.ID_klient = Klienci.ID_klient"></asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="pozycjeSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:sklepBHPConnectionString %>" 
                ...
                UpdateCommand="UPDATE [Pozycje_zamowienia] SET [ID_zamowienia] = @ID_zamowienia, [ID_produkt] = @ID_produkt, [Ilosc_zamowionych_produktow] = @Ilosc_zamowionych_produktow WHERE [ID_pozycji] = @ID_pozycji">
                <DeleteParameters>
